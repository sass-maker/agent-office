...
### Requirement: Office motion reflects real employee state
...
Labels SHALL emphasize selected or active employees rather than remaining as a
permanent overlay, and ambient movement SHALL NOT imply work that is absent
